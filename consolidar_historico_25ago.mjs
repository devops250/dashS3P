...
// da tabela "Disparo Jun26" (Yara SDR era) até 25/ago/2026.
...
const DEADLINE = new Date("2026-08-25T23:59:59-03:00");
...
console.log("Consolidação histórica — todas as campanhas Yara até 25/ago/2026");
console.log("=".repeat(60));
...
writeFileSync("historico_consolidado_25ago.json", JSON.stringify(out, null, 2));

console.log("\n" + "=".repeat(60));
console.log("HISTÓRICO CONSOLIDADO (Yara atual até 25/ago)");
console.log("=".repeat(60));
...
console.log(`\nSalvo em: historico_consolidado_25ago.json`);
