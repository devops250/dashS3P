// Análise período 29/05 a 03/06/2026
...
function horaMensagemNoPeriodo(s) {
  ...
  if (mes === "maio") return day >= 29 && day <= 31;
  if (mes === "junho") return day >= 1 && day <= 3;
  return false;
}
...
async function main() {
  ...
  console.log("ANÁLISE S3P - Disparo mai25 - 29/05 a 03/06/2026");
  console.log("=".repeat(70));
  ...
  console.log(`  Contatados 29/05-03/06 (Disparo=true): ${contatados.length}`);
  ...
  const relatorio = {
    periodo: { inicio: "2026-05-29", fim: "2026-06-03" },
  ...
  writeFileSync("relatorio_29mai_03jun.json", JSON.stringify(relatorio, null, 2));

  console.log("\n" + "=".repeat(70));
  console.log("RESULTADO 29/05 a 03/06/2026");
  console.log("=".repeat(70));
  ...
  console.log("\nArquivo: relatorio_29mai_03jun.json");
}
